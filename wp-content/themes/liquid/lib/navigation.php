...
/**
 * Foundation 5 Top Bar Menu Walker
 */
 
class LiquidNavigation extends Walker_Nav_Menu
{ 
...
add_filter('wp_page_menu', array('LiquidNavigation','items_default_wrap'));
add_action('wp_head', array('LiquidNavigation','items_remove_defaut_wrapper'));