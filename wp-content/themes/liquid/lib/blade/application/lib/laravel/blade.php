...
class Blade {
	...
	/**
	 * Rewrites Blade curly brackets into PHP tags.
	 *
	 * @param  string  $value
	 * @return string
	 */
	protected static function compile_tags($value)
	{
		$value = preg_replace('/\{\{\{(.+?)\}\}\}/', '<?php HTML::entities($1); ?>', $value);

		return preg_replace('/\{\{(.+?)\}\}/', '<?php $1; ?>', $value);
	}
	
	protected static function compile_phpopen($value)
	{
	...
	protected static function compile_phpclose($value)
	{
